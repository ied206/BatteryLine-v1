...
wchar_t* BL_DefaultSettingStr =
	L"# Joveler's BatteryLine\r\n\r\n"
	L"[General]\r\n"
	L"# showcharge   : Show BatteryLine when charging\r\n"
	L"#                  {true, false}\r\n"
	L"# monitor      : Which monitor to view BatteryLine?\r\n"
	L"#                Note : Experimental option, May contatin bugs\r\n"
	L"#                  {primary, 1, 2, ... , 32}\r\n"
	L"#                  primary for using primary monitor\r\n"
	L"#                  number for n'th monitor\r\n"
	L"#                   (Number can point all monitors, primary and non-primary)\r\n"
	L"#                   (Monitor number is relative, it is prone to change)\r\n"
	L"#                   (Strongly recommend to use default \'primary\' option)\r\n"
	L"# position     : BatteryLine's position\r\n"
	L"#                  {top, bottom, left, right}\r\n"
	L"# taskbar      : Move BatteryLine when meet with taskbar\r\n"
	L"#                  {ignore, evade}\r\n"
	...
	L"# fullcolor    : BatteryLine's color when battery is full\r\n"
	L"# Format : {R, G, B}\r\n"
	L"defaultcolor = 0, 255, 0\r\n"
	L"chargecolor  = 0, 200, 255\r\n"
	L"fullcolor    = 0, 162, 232\r\n"
	L"# Support up to 16 thresholds\r\n"
	L"# Format : {LowEdge, HighEdge, R, G, B}\r\n"
	L"color = 0, 20, 237, 28, 36\r\n"
	L"color = 20, 50, 255, 140, 15\r\n";
