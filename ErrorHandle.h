...
#define JVERR_OPT_INI_INVALID_SHOWCHARGE		202
#define JVERR_OPT_INI_INVALID_MONITOR			203
#define JVERR_OPT_INI_NOT_EXIST_MONITOR			204
#define JVERR_OPT_INI_INVALID_POSITION			205
#define JVERR_OPT_INI_INVALID_TASKBAR			206
#define JVERR_OPT_INI_INVALID_TRANSPARENCY		207
#define JVERR_OPT_INI_INVALID_HEIGHT			208
#define JVERR_OPT_INI_INVALID_DEFAULTCOLOR		209
#define JVERR_OPT_INI_INVALID_CHARGECOLOR		210
#define JVERR_OPT_INI_INVALID_FULLCOLOR			211
#define JVERR_OPT_INI_INVALID_COLOR				212
#define JVERR_OPT_INI_TOO_MUCH_COLOR			213
// 25x : Invalid Option
